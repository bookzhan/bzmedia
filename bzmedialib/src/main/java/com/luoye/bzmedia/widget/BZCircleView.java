 ...
 * description:
 */
public class BZCircleView extends View {

    private final Paint paint;
    private final float dp_1;

    public BZCircleView(Context context) {
        this(context, null);
    }

    public BZCircleView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BZCircleView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
